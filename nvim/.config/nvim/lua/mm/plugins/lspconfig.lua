		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("gi", vim.lsp.buf.implementation, "Go Implementation")

					map("go", vim.lsp.buf.type_definition, "Type Definition")
					map("gD", vim.lsp.buf.declaration, "Go declaration")

					map("<F2>", vim.lsp.buf.rename, "Rename")
					map("<F3>", vim.lsp.buf.format, "Format") -- Ask lsp to format, but better use conform.nvim <leader>f
